...
class CondType11(Conductor):
    ...
    Hwire = property(
        fget=_get_Hwire,
        fset=_set_Hwire,
        doc="""cf schematics, single wire height without insulation [m]
    ...
    Wwire = property(
        fget=_get_Wwire,
        fset=_set_Wwire,
        doc="""cf schematics, single wire width without insulation [m]
    ...
    Wins_coil = property(
        fget=_get_Wins_coil,
        fset=_set_Wins_coil,
        doc="""(advanced) cf schematics, winding coil insulation  thickness [m]
    ...
    type_winding_shape = property(
        ...
        doc="""type of winding shape for end winding length calculation\n0 for hairpin windings\n1 for normal windings
    ...
    alpha_ew = property(
        fget=_get_alpha_ew,
        fset=_set_alpha_ew,
        doc="""angle of winding overhang hairpin coils [deg]
