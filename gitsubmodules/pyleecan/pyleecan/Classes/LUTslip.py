...
class LUTslip(LUT):
    ...
    Phi_m = property(
        fget=_get_Phi_m,
        fset=_set_Phi_m,
        doc="""Magnetizing flux for a given magnetizing current I_m
    ...
    I_m = property(
        fget=_get_I_m,
        fset=_set_I_m,
        doc="""Stator magnetizing current
    ...
    T2_ref = property(
        fget=_get_T2_ref,
        fset=_set_T2_ref,
        doc="""Rotor bar average temperature at which Phi_m is given
    ...
    R2 = property(
        fget=_get_R2,
        fset=_set_R2,
        doc="""DC rotor winding resistance at T2_ref already expressed per phase in stator frame 
    ...
    L2 = property(
        fget=_get_L2,
        fset=_set_L2,
        doc="""Rotor winding leakage inductance
