...
class Electrical(FrozenClass):
    ...
    Tsta = property(
        fget=_get_Tsta,
        fset=_set_Tsta,
        doc="""Average stator temperature for operational EEC calculation
    ...
    Trot = property(
        fget=_get_Trot,
        fset=_set_Trot,
        doc="""Average rotor temperature for operational EEC calculation
    ...
    Tmag = property(
        fget=_get_Tmag,
        fset=_set_Tmag,
        doc="""Average magnet temperature for operational EEC calculation
