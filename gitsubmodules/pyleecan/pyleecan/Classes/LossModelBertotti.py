...
class LossModelBertotti(LossModel):
    ...
    alpha_hy = property(
        fget=_get_alpha_hy,
        fset=_set_alpha_hy,
        doc="""Hysteresis loss power coefficient
    ...
    alpha_ed = property(
        fget=_get_alpha_ed,
        fset=_set_alpha_ed,
        doc="""Eddy current loss power coefficient
    ...
    alpha_ex = property(
        fget=_get_alpha_ex,
        fset=_set_alpha_ex,
        doc="""Excess loss power coefficient
    ...
    group = property(
        fget=_get_group,
        fset=_set_group,
        doc="""String to override default FEA group to apply model
    ...
    N0 = property(
        fget=_get_N0,
        fset=_set_N0,
        doc="""List of rotor speeds to override actual speed
