...
class LUT(FrozenClass):
    ...
    R1 = property(
        fget=_get_R1,
        fset=_set_R1,
        doc="""DC phase winding resistance at T1_ref per phase 
    ...
    L1 = property(
        fget=_get_L1,
        fset=_set_L1,
        doc="""Phase winding leakage inductance 
    ...
    T1_ref = property(
        fget=_get_T1_ref,
        fset=_set_T1_ref,
        doc="""Stator winding average temperature associated to R1, L1 parameters
    ...
    OP_matrix = property(
        fget=_get_OP_matrix,
        fset=_set_OP_matrix,
        doc="""Array of operating point values of size (N,5) with N the number of operating points (Speed, Id, Iq, Torque, Power). OP values are set to nan if they are not given.
