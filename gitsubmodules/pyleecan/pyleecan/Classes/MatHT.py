...
class MatHT(FrozenClass):
    ...
    def __str__(self):
        ...
        MatHT_str += "mu = " + str(self.mu) + linesep
        return MatHT_str
    ...
    def compare(self, other, name="self", ignore_list=None):
        ...
        if other._mu != self._mu:
            diff_list.append(name + ".mu")
    ...
    lambda_x = property(
        fget=_get_lambda_x,
        fset=_set_lambda_x,
        doc="""thermal conductivity (XY is lamination plane, Z is rotation axis)
    ...
    def _set_mu(self, value):
        """setter of mu"""
        check_var("mu", value, "float", Vmin=0)
        self._mu = value
