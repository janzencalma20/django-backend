...
class FluxLinkFEMM(FluxLink):
    ...
    is_periodicity_a = property(
        ...
        doc="""True to take into account the spatial periodicity of the machine
    ...
    Nt_tot = property(
        fget=_get_Nt_tot,
        fset=_set_Nt_tot,
        doc="""Number of time steps for the FEMM simulation
    ...
    Kgeo_fineness = property(
        ...
        doc="""global coefficient to adjust geometry fineness in FEMM (0.5 : default , > 1 : finner , < 1 : less fine)
