...
class OutElec(FrozenClass):
    ...
    Pem_av_ref = property(
        ...
        doc="""Theoretical Average Electromagnetic Power
    ...
    Tem_av_ref = property(
        ...
        doc="""Theoretical Average Electromagnetic torque
    ...
    eec_param = property(
        fget=_get_eec_param,
        fset=_set_eec_param,
        doc="""Dict containing parameters used in Electric Equivalent Circuit
