...
class Winding(FrozenClass):
    ...
    Nslot_shift_wind = property(
        ...
        doc="""0 not to change the stator winding connection matrix built by pyleecan number of slots to shift the coils obtained with pyleecan winding algorithm (a, b, c becomes b, c, a with Nslot_shift_wind1=1)
    ...
    Lewout = property(
        fget=_get_Lewout,
        fset=_set_Lewout,
        doc="""straight length of the conductors outside the lamination before the curved part of winding overhang [m] - can be negative to tune the average turn length 
    ...
    Nlayer = property(
        fget=_get_Nlayer,
        fset=_set_Nlayer,
        doc="""Number of layers per slots
