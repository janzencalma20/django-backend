...
class VarLoad(VarSimu):
    ...
    OP_matrix = property(
        fget=_get_OP_matrix,
        fset=_set_OP_matrix,
        doc="""Operating point matrix (N0,I0,Phi0,T,P) or (N0,Id,Iq,T,P) or (N0,U0,s,T,P)
    ...
    type_OP_matrix = property(
        ...
        doc="""Select which kind of OP_matrix is used 0: (N0,I0,Phi0,T,P), 1:(N0,Id,Iq,T,P), 2:(N0,U0,s,T,P)
    ...
    is_torque = property(
        fget=_get_is_torque,
        fset=_set_is_torque,
        doc="""True if the Torque is defined in OP_matrix
    ...
    is_power = property(
        fget=_get_is_power,
        fset=_set_is_power,
        doc="""True if the Power is defined in OP_matrix
